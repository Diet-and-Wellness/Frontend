      ...
      <div className="flex flex-col items-start gap-2.5 p-5">
        {type === "landing" && (
          <div className="flex flex-row gap-5 items-center">
            <p className="type-label font-medium text-[#3E7228]">
        ...
        <h5 className="type-card-title line-clamp-1 font-semibold">
          {blog.title}
        </h5>

        <p className="type-body line-clamp-3 text-[#4F4F4F]">
          {blog.description}
        </p>
        ...
        {type === "landing" && (
          ...
          >
            <span className="type-control text-center font-bold text-[#2E551E] group-hover:text-white transition-colors duration-400">
              {t("blogs.readMore")}
            </span>
          </Link>
        )}
